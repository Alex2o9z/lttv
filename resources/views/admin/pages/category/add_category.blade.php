...
@php
	$title = __('lang.addcategory');
	session()->put('index', 'addcategory');
@endphp
@section('title',$title)
	...
	<main class="main">
		<div class="container-fluid">
			<div class="row">
				...
				<!-- form -->
				<div class="col-12">
					<form action="{{route('admin.category.store')}}" method="POST" class="form" enctype="multipart/form-data">
						@csrf
						<div class="row">
							...
							<div class="col-12 col-md-7 form__content">
								<div class="row">
									<div class="col-12 text-white">
										<label for="Vietnamese">{{__('lang.category')}} ( {{__('lang.vi')}} )</label>
									</div>
								...
								<div class="row">
									...
									<div class="col-12 text-white">
										<label for="English">{{__('lang.category')}} ( {{__('lang.en')}} )</label>
									</div>
